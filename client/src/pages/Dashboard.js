            ...
            <div className="flex flex-col md:flex-row justify-center pb-1">
                    ...
                    <div className="ml-10">
                        <div className="flex items-center">
                            ...
                            aria-label="Settings">
                                <Link to="/settings"><svg className="h-8 w-8 dark:text-white transition duration-500" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24">
