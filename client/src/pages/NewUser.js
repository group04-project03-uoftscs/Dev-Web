...
console.log(state)
  ...
  return (
    <div className="flex flex-col pb-40 bg-gray-200">
      <form onSubmit={handleSubmit}>
        <section className="py-20  bg-opacity-50 h-screen">
        <div className="mx-auto container max-w-2xl md:w-3/4 shadow-md">
          ...
          <div className="bg-white space-y-6">
            ...
            <hr />
            <div className="md:inline-flex w-full space-y-2 md:space-y-0 pb-8 pt-4 pr-32 sm:pl-4 text-gray-500 items-center">
